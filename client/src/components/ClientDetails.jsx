...
const ClientDetails = ( {closeDetails} ) => {
                    ...
                    <div className='w-[100%] flex '>
                        <div className='w-[100%] flex flex-col gap-10 justify-center '>
                            ...
                            <div className='flex justify-between md:w-[50%]'>
                                <div onClick={closeDetails} className='cursor-pointer flex items-center'>
                                    <FontAwesomeIcon icon={faChevronLeft} color='#828282'/>
                                    <h2 className=' ml-3 text-[#828282]'>Back to Clients</h2>
                                </div>
                                <button type="button" className="btn btn-outline btn-accent -mt-5 border rounded-lg p-3 bg-[#A3A7FC] w-[40%] text-white hover:opacity-80">
                                    Apply Discount
                                </button>
                            </div>
                        </div>

                ...
                <div className='contact-content w-[80%] shadow-2xl justify-center md:flex md:h-[800px]'>
                    <div className='w-[100%] flex bg-[#FBEFF2] '>
                        <form onSubmit={formik.handleSubmit} className='w-[100%] flex flex-col gap-10 justify-center my-12'>
                            ...
                            <input className='rounded-md p-3 placeholder-gray-400 w-[60%] mx-auto'
                            ...
                            <textarea style={{ resize: 'none' }} className='rounded-md p-3 placeholder-gray-400 w-[60%] mx-auto' cols="40" rows="5"
                            ...
                            <button type="submit" className='border-[#A10550] border-2 p-3 w-[60%] mx-auto text-[#A10550] shadow-xl'>Contact Us</button>
                        </form>
                    </div>

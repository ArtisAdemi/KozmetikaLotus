                ...
                <div className='contact-content w-[80%] shadow-2xl justify-center flex' style={{ height: '800px' }}>
                    ...
                    <div className='w-[100%] flex bg-[#FBEFF2]'>
                        ...
                        <form className='w-[100%] flex flex-col gap-10 p-5 justify-center'>
                            ...
                            <input className='rounded-md p-4 placeholder-gray-400 w-[60%] mx-auto' type="text" name="username" placeholder='Username' id="username" required />
                            <input className='rounded-md p-4 placeholder-gray-400 w-[60%] mx-auto' type="text" name="role" placeholder='Role' id="role" required />
